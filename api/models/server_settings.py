...
from environment import SMS_RU_API_KEY, SBER_API_URL, SBER_API_LOGIN, SBER_API_PASSWORD, SBER_API_PAYMENT_TIME_LIMIT
...
class ServerSettings(models.Model):
    ...
    sber_api_payment_time_limit_sec = models.PositiveIntegerField(default=SBER_API_PAYMENT_TIME_LIMIT)
